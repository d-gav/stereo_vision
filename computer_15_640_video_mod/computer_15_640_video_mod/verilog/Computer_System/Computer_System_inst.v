	Computer_System u0 (
		...
		.ebab_video_in_external_interface_address     (<connected-to-ebab_video_in_external_interface_address>),     //  ebab_video_in_external_interface.address
		.ebab_video_in_external_interface_byte_enable (<connected-to-ebab_video_in_external_interface_byte_enable>), //                                  .byte_enable
		.ebab_video_in_external_interface_read        (<connected-to-ebab_video_in_external_interface_read>),        //                                  .read
		.ebab_video_in_external_interface_write       (<connected-to-ebab_video_in_external_interface_write>),       //                                  .write
		...
		.pio_y_trim_external_connection_export        (<connected-to-pio_y_trim_external_connection_export>)         //    pio_y_trim_external_connection.export
	);
