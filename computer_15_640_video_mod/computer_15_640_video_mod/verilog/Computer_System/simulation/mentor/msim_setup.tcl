...
# ----------------------------------------
# ACDS 18.1 625 win32 2026.05.05.22:38:16
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_pio_big_pen.v"                                                                                               -work pio_big_pen                                               
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/stereo_onchip_ram.sv"                                                                           -L altera_common_sv_packages -work Onchip_SRAM                                               
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L error_adapter_0 -L Video_Stream_Splitter -L Video_Stream_Merger -L Edge_Detection_Router_Controller -L Edge_Detection -L Chroma_Upsampler -L Chroma_Filter -L video_pll -L border -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_002 -L router -L avalon_st_adapter_001 -L avalon_st_adapter -L crosser -L ARM_A9_HPS_h2f_axi_master_wr_to_SDRAM_s1_cmd_width_adapter -L rsp_mux_003 -L rsp_mux_002 -L rsp_demux_002 -L rsp_demux_001 -L cmd_mux_002 -L cmd_mux_001 -L cmd_demux_003 -L cmd_demux_002 -L SDRAM_s1_burst_adapter -L ARM_A9_HPS_h2f_axi_master_wr_limiter -L router_006 -L router_005 -L router_004 -L router_003 -L SDRAM_s1_agent_rsp_fifo -L SDRAM_s1_agent -L EBAB_video_in_avalon_master_agent -L ARM_A9_HPS_h2f_axi_master_agent -L SDRAM_s1_translator -L EBAB_video_in_avalon_master_translator -L Video_In_RGB_Resampler -L Video_In_DMA -L Video_In_Clipper -L Video_In_Chroma_Resampler -L Video_In_CSC -L Video_In -L Edge_Detection_Subsystem -L VGA_Pixel_RGB_Resampler -L VGA_Pixel_FIFO -L VGA_Pixel_DMA -L VGA_PLL -L VGA_Dual_Clock_FIFO -L VGA_Controller -L VGA_Char_Buffer -L VGA_Alpha_Blender -L reset_from_locked -L sys_pll -L hps_io -L fpga_interfaces -L rst_controller -L irq_mapper -L mm_interconnect_4 -L mm_interconnect_3 -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L pio_big_pen -L pio_0 -L Video_In_Subsystem -L VGA_Subsystem -L System_PLL -L SDRAM -L Pixel_DMA_Addr_Translation -L Onchip_SRAM -L EBAB_video_in -L AV_Config -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
