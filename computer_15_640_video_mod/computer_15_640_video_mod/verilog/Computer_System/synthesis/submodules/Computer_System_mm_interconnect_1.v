...
module Computer_System_mm_interconnect_1 (
	...
	wire          pixel_dma_addr_translation_slave_agent_rp_valid;                                     // Pixel_DMA_Addr_Translation_slave_agent:rp_valid -> router_005:sink_valid
	wire  [115:0] pixel_dma_addr_translation_slave_agent_rp_data;                                      // Pixel_DMA_Addr_Translation_slave_agent:rp_data -> router_005:sink_data
	wire          pixel_dma_addr_translation_slave_agent_rp_ready;                                     // router_005:sink_ready -> Pixel_DMA_Addr_Translation_slave_agent:rp_ready
	wire          pixel_dma_addr_translation_slave_agent_rp_startofpacket;                             // Pixel_DMA_Addr_Translation_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          pixel_dma_addr_translation_slave_agent_rp_endofpacket;                               // Pixel_DMA_Addr_Translation_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          video_in_dma_addr_translation_slave_agent_rp_valid;                                  // Video_In_DMA_Addr_Translation_slave_agent:rp_valid -> router_006:sink_valid
	wire  [115:0] video_in_dma_addr_translation_slave_agent_rp_data;                                   // Video_In_DMA_Addr_Translation_slave_agent:rp_data -> router_006:sink_data
	wire          video_in_dma_addr_translation_slave_agent_rp_ready;                                  // router_006:sink_ready -> Video_In_DMA_Addr_Translation_slave_agent:rp_ready
	wire          video_in_dma_addr_translation_slave_agent_rp_startofpacket;                          // Video_In_DMA_Addr_Translation_slave_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          video_in_dma_addr_translation_slave_agent_rp_endofpacket;                            // Video_In_DMA_Addr_Translation_slave_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire    [4:0] cmd_mux_002_src_channel;                                                             // cmd_mux_002:src_channel -> Video_In_Subsystem_edge_detection_control_slave_burst_adapter:sink0_channel
	...
	wire    [4:0] video_in_subsystem_edge_detection_control_slave_burst_adapter_source0_channel;       // Video_In_Subsystem_edge_detection_control_slave_burst_adapter:source0_channel -> Video_In_Subsystem_edge_detection_control_slave_agent:cp_channel
	...
	wire          cmd_mux_003_src_valid;                                                               // cmd_mux_003:src_valid -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_003_src_data;                                                                // cmd_mux_003:src_data -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                               // Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                             // cmd_mux_003:src_channel -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                                                       // cmd_mux_003:src_startofpacket -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                         // cmd_mux_003:src_endofpacket -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                               // cmd_mux_004:src_valid -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_004_src_data;                                                                // cmd_mux_004:src_data -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                               // Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                             // cmd_mux_004:src_channel -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                       // cmd_mux_004:src_startofpacket -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                         // cmd_mux_004:src_endofpacket -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_endofpacket
	...
	wire    [4:0] video_in_dma_addr_translation_slave_burst_adapter_source0_channel;                   // Video_In_DMA_Addr_Translation_slave_burst_adapter:source0_channel -> Video_In_DMA_Addr_Translation_slave_agent:cp_channel
	...
	wire          pixel_dma_addr_translation_slave_agent_rdata_fifo_out_valid;                         // Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] pixel_dma_addr_translation_slave_agent_rdata_fifo_out_data;                          // Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          pixel_dma_addr_translation_slave_agent_rdata_fifo_out_ready;                         // avalon_st_adapter_003:in_0_ready -> Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                   // avalon_st_adapter_003:out_0_valid -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                    // avalon_st_adapter_003:out_0_data -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                   // Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                   // avalon_st_adapter_003:out_0_error -> Pixel_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_error
	wire          video_in_dma_addr_translation_slave_agent_rdata_fifo_out_valid;                      // Video_In_DMA_Addr_Translation_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] video_in_dma_addr_translation_slave_agent_rdata_fifo_out_data;                       // Video_In_DMA_Addr_Translation_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          video_in_dma_addr_translation_slave_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_004:in_0_ready -> Video_In_DMA_Addr_Translation_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                   // avalon_st_adapter_004:out_0_valid -> Video_In_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                    // avalon_st_adapter_004:out_0_data -> Video_In_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                   // Video_In_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                   // avalon_st_adapter_004:out_0_error -> Video_In_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_error
