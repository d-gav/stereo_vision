...
module Computer_System_mm_interconnect_1 (
	...
	wire  [117:0] pixel_dma_addr_translation_slave_agent_rp_data;                                      // Pixel_DMA_Addr_Translation_slave_agent:rp_data -> router_010:sink_data
	...
	wire  [117:0] video_in_dma_addr_translation_slave_agent_rp_data;                                   // Video_In_DMA_Addr_Translation_slave_agent:rp_data -> router_011:sink_data
	...
	wire    [9:0] cmd_mux_src_channel;                                                                 // cmd_mux:src_channel -> AV_Config_avalon_av_config_slave_burst_adapter:sink0_channel
	...
	wire    [9:0] av_config_avalon_av_config_slave_burst_adapter_source0_channel;                      // AV_Config_avalon_av_config_slave_burst_adapter:source0_channel -> AV_Config_avalon_av_config_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_001_src_channel;                                                             // cmd_mux_001:src_channel -> VGA_Subsystem_char_buffer_control_slave_burst_adapter:sink0_channel
	...
	wire    [9:0] vga_subsystem_char_buffer_control_slave_burst_adapter_source0_channel;               // VGA_Subsystem_char_buffer_control_slave_burst_adapter:source0_channel -> VGA_Subsystem_char_buffer_control_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_002_src_channel;                                                             // cmd_mux_002:src_channel -> Video_In_Subsystem_edge_detection_control_slave_burst_adapter:sink0_channel
	...
	wire    [9:0] video_in_subsystem_edge_detection_control_slave_burst_adapter_source0_channel;       // Video_In_Subsystem_edge_detection_control_slave_burst_adapter:source0_channel -> Video_In_Subsystem_edge_detection_control_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_003_src_channel;                                                             // cmd_mux_003:src_channel -> pio_0_s1_burst_adapter:sink0_channel
	...
	wire    [9:0] pio_0_s1_burst_adapter_source0_channel;                                              // pio_0_s1_burst_adapter:source0_channel -> pio_0_s1_agent:cp_channel
	...
	wire    [9:0] cmd_mux_004_src_channel;                                                             // cmd_mux_004:src_channel -> pio_small_pen_s1_burst_adapter:sink0_channel
	...
	wire    [9:0] pio_small_pen_s1_burst_adapter_source0_channel;                                      // pio_small_pen_s1_burst_adapter:source0_channel -> pio_small_pen_s1_agent:cp_channel
	...
	wire    [9:0] cmd_mux_005_src_channel;                                                             // cmd_mux_005:src_channel -> pio_big_pen_s1_burst_adapter:sink0_channel
	...
	wire    [9:0] pio_big_pen_s1_burst_adapter_source0_channel;                                        // pio_big_pen_s1_burst_adapter:source0_channel -> pio_big_pen_s1_agent:cp_channel
	...
	wire    [9:0] cmd_mux_006_src_channel;                                                             // cmd_mux_006:src_channel -> pio_max_disp_s1_burst_adapter:sink0_channel
	...
	wire    [9:0] pio_max_disp_s1_burst_adapter_source0_channel;                                       // pio_max_disp_s1_burst_adapter:source0_channel -> pio_max_disp_s1_agent:cp_channel
	...
	wire    [9:0] cmd_mux_007_src_channel;                                                             // cmd_mux_007:src_channel -> pio_min_disp_s1_burst_adapter:sink0_channel
	...
	wire    [9:0] pio_min_disp_s1_burst_adapter_source0_channel;                                       // pio_min_disp_s1_burst_adapter:source0_channel -> pio_min_disp_s1_agent:cp_channel
	...
	wire          cmd_mux_008_src_valid;                                                               // cmd_mux_008:src_valid -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_008_src_data;                                                                // cmd_mux_008:src_data -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                                               // Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire    [9:0] cmd_mux_008_src_channel;                                                             // cmd_mux_008:src_channel -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_channel
	wire          cmd_mux_008_src_startofpacket;                                                       // cmd_mux_008:src_startofpacket -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                         // cmd_mux_008:src_endofpacket -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_endofpacket
	...
	wire    [9:0] pixel_dma_addr_translation_slave_burst_adapter_source0_channel;                      // Pixel_DMA_Addr_Translation_slave_burst_adapter:source0_channel -> Pixel_DMA_Addr_Translation_slave_agent:cp_channel
	...
	wire          cmd_mux_009_src_valid;                                                               // cmd_mux_009:src_valid -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_009_src_data;                                                                // cmd_mux_009:src_data -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_data
	wire          cmd_mux_009_src_ready;                                                               // Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_ready -> cmd_mux_009:src_ready
	wire    [9:0] cmd_mux_009_src_channel;                                                             // cmd_mux_009:src_channel -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_channel
	wire          cmd_mux_009_src_startofpacket;                                                       // cmd_mux_009:src_startofpacket -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                         // cmd_mux_009:src_endofpacket -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_endofpacket
	...
	wire    [9:0] video_in_dma_addr_translation_slave_burst_adapter_source0_channel;                   // Video_In_DMA_Addr_Translation_slave_burst_adapter:source0_channel -> Video_In_DMA_Addr_Translation_slave_agent:cp_channel
	...
	wire          pixel_dma_addr_translation_slave_agent_rdata_fifo_out_valid;                         // Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] pixel_dma_addr_translation_slave_agent_rdata_fifo_out_data;                          // Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	wire          pixel_dma_addr_translation_slave_agent_rdata_fifo_out_ready;                         // avalon_st_adapter_008:in_0_ready -> Pixel_DMA_Addr_Translation_slave_agent_rdata_fifo:out_ready
	...
	wire          video_in_dma_addr_translation_slave_agent_rdata_fifo_out_valid;                      // Video_In_DMA_Addr_Translation_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] video_in_dma_addr_translation_slave_agent_rdata_fifo_out_data;                       // Video_In_DMA_Addr_Translation_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_009:in_0_data
	wire          video_in_dma_addr_translation_slave_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_009:in_0_ready -> Video_In_DMA_Addr_Translation_slave_agent_rdata_fifo:out_ready
