...
parameter DROP_LINES_AT_START		= 44;
parameter DROP_LINES_AT_END		= 44;

parameter WIDTH_OUT					= 720; // Final frame's width in pixels
parameter HEIGHT_OUT					= 200; // Final frame's height in lines
