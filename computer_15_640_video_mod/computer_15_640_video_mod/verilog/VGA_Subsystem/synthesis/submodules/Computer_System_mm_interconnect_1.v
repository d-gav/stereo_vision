...
module Computer_System_mm_interconnect_1 (
	...
	wire          video_in_dma_addr_translation_slave_agent_rp_valid;                                  // Video_In_DMA_Addr_Translation_slave_agent:rp_valid -> router_007:sink_valid
	wire  [115:0] video_in_dma_addr_translation_slave_agent_rp_data;                                   // Video_In_DMA_Addr_Translation_slave_agent:rp_data -> router_007:sink_data
	wire          video_in_dma_addr_translation_slave_agent_rp_ready;                                  // router_007:sink_ready -> Video_In_DMA_Addr_Translation_slave_agent:rp_ready
	wire          video_in_dma_addr_translation_slave_agent_rp_startofpacket;                          // Video_In_DMA_Addr_Translation_slave_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          video_in_dma_addr_translation_slave_agent_rp_endofpacket;                            // Video_In_DMA_Addr_Translation_slave_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire    [5:0] router_src_channel;                                                                  // router:src_channel -> ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:cmd_sink_channel
	...
	wire    [5:0] arm_a9_hps_h2f_lw_axi_master_wr_limiter_cmd_src_channel;                             // ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [5:0] rsp_mux_src_channel;                                                                 // rsp_mux:src_channel -> ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:rsp_sink_channel
	...
	wire    [5:0] router_001_src_channel;                                                              // router_001:src_channel -> ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:cmd_sink_channel
	...
	wire    [5:0] arm_a9_hps_h2f_lw_axi_master_rd_limiter_cmd_src_channel;                             // ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [5:0] rsp_mux_001_src_channel;                                                             // rsp_mux_001:src_channel -> ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:rsp_sink_channel
	...
	wire    [5:0] cmd_mux_src_channel;                                                                 // cmd_mux:src_channel -> AV_Config_avalon_av_config_slave_burst_adapter:sink0_channel
	...
	wire    [5:0] av_config_avalon_av_config_slave_burst_adapter_source0_channel;                      // AV_Config_avalon_av_config_slave_burst_adapter:source0_channel -> AV_Config_avalon_av_config_slave_agent:cp_channel
	...
	wire    [5:0] cmd_mux_001_src_channel;                                                             // cmd_mux_001:src_channel -> VGA_Subsystem_char_buffer_control_slave_burst_adapter:sink0_channel
	...
	wire    [5:0] vga_subsystem_char_buffer_control_slave_burst_adapter_source0_channel;               // VGA_Subsystem_char_buffer_control_slave_burst_adapter:source0_channel -> VGA_Subsystem_char_buffer_control_slave_agent:cp_channel
	...
	wire    [5:0] cmd_mux_002_src_channel;                                                             // cmd_mux_002:src_channel -> Video_In_Subsystem_edge_detection_control_slave_burst_adapter:sink0_channel
	...
	wire    [5:0] video_in_subsystem_edge_detection_control_slave_burst_adapter_source0_channel;       // Video_In_Subsystem_edge_detection_control_slave_burst_adapter:source0_channel -> Video_In_Subsystem_edge_detection_control_slave_agent:cp_channel
	...
	wire    [5:0] cmd_mux_003_src_channel;                                                             // cmd_mux_003:src_channel -> pio_0_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] cmd_mux_004_src_channel;                                                             // cmd_mux_004:src_channel -> Pixel_DMA_Addr_Translation_slave_burst_adapter:sink0_channel
	...
	wire    [5:0] pixel_dma_addr_translation_slave_burst_adapter_source0_channel;                      // Pixel_DMA_Addr_Translation_slave_burst_adapter:source0_channel -> Pixel_DMA_Addr_Translation_slave_agent:cp_channel
	...
	wire          cmd_mux_005_src_valid;                                                               // cmd_mux_005:src_valid -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_005_src_data;                                                                // cmd_mux_005:src_data -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                               // Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                             // cmd_mux_005:src_channel -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                                       // cmd_mux_005:src_startofpacket -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                         // cmd_mux_005:src_endofpacket -> Video_In_DMA_Addr_Translation_slave_burst_adapter:sink0_endofpacket
	...
	wire    [5:0] video_in_dma_addr_translation_slave_burst_adapter_source0_channel;                   // Video_In_DMA_Addr_Translation_slave_burst_adapter:source0_channel -> Video_In_DMA_Addr_Translation_slave_agent:cp_channel
	...
	wire    [5:0] arm_a9_hps_h2f_lw_axi_master_wr_limiter_cmd_valid_data;                              // ARM_A9_HPS_h2f_lw_axi_master_wr_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [5:0] arm_a9_hps_h2f_lw_axi_master_rd_limiter_cmd_valid_data;                              // ARM_A9_HPS_h2f_lw_axi_master_rd_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          video_in_dma_addr_translation_slave_agent_rdata_fifo_out_valid;                      // Video_In_DMA_Addr_Translation_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] video_in_dma_addr_translation_slave_agent_rdata_fifo_out_data;                       // Video_In_DMA_Addr_Translation_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          video_in_dma_addr_translation_slave_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_005:in_0_ready -> Video_In_DMA_Addr_Translation_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                   // avalon_st_adapter_005:out_0_valid -> Video_In_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                    // avalon_st_adapter_005:out_0_data -> Video_In_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                   // Video_In_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                   // avalon_st_adapter_005:out_0_error -> Video_In_DMA_Addr_Translation_slave_agent:rdata_fifo_sink_error
