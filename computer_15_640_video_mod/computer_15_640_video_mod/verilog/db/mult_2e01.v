//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=11 LPM_WIDTHB=10 LPM_WIDTHP=21 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=12 dataa datab result
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=12 cin dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
module  mult_2e01
	...
	wire	[11:0]	wire_sum_adder1aa_0dataa;
	wire	[11:0]	wire_sum_adder1aa_0datab;
	wire	[11:0]	wire_sum_adder1aa_0result;
	wire	[11:0]	wire_sum_adder1aa_1dataa;
	wire	[11:0]	wire_sum_adder1aa_1datab;
	wire	[11:0]	wire_sum_adder1aa_1result;
	wire	[11:0]	wire_sum_adder1aa_2dataa;
	wire	[11:0]	wire_sum_adder1aa_2datab;
	wire	[11:0]	wire_sum_adder1aa_2result;
	wire	[11:0]	wire_sum_adder1aa_3dataa;
	wire	[11:0]	wire_sum_adder1aa_3datab;
	wire	[11:0]	wire_sum_adder1aa_3result;
	wire	[12:0]	wire_sum_adder1aa_4result_int;
	wire	wire_sum_adder1aa_4cin;
	wire	[11:0]	wire_sum_adder1aa_4dataa;
	wire	[11:0]	wire_sum_adder1aa_4datab;
	wire	[11:0]	wire_sum_adder1aa_4result;
	...
	wire  [10:0]  dataa_node;
	wire  [9:0]  datab_node;
	wire  [20:0]  final_result_node;
	wire  w219w;
	wire  w228w;
	wire  [21:0]  w370w;
	wire  [109:0]  w_decoder_node9w;
	wire  [9:0]  w_le_datab_node8w;
	wire  [64:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_0dataa = {w_decoder_node9w[21], w_decoder_node9w[21:11]},
		wire_sum_adder1aa_0datab = {{2{w_decoder_node9w[10]}}, w_decoder_node9w[10:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {w_decoder_node9w[43], w_decoder_node9w[43:33]},
		wire_sum_adder1aa_1datab = {{2{w_decoder_node9w[32]}}, w_decoder_node9w[32:23]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {w_decoder_node9w[65], w_decoder_node9w[65:55]},
		wire_sum_adder1aa_2datab = {{2{w_decoder_node9w[54]}}, w_decoder_node9w[54:45]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {w_decoder_node9w[87], w_decoder_node9w[87:77]},
		wire_sum_adder1aa_3datab = {{2{w_decoder_node9w[76]}}, w_decoder_node9w[76:67]};
	assign
	...
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4result_int[12:1];
	assign
		wire_sum_adder1aa_4cin = 1'b1,
		wire_sum_adder1aa_4dataa = {(~ w_decoder_node9w[109]), (~ w_decoder_node9w[109:99])},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[98]}}, w_decoder_node9w[98:89]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w228w, {w228w, {w228w, {w228w, {(~ w_sum_node10w[25]), {w219w, {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {2{w228w}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w228w, {w_sum_node10w[24], w219w}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w228w, {w228w, w_sum_node10w[23]}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft3a_in = {w219w, {(~ w_sum_node10w[64]), {w_sum_node10w[63], {(~ w_sum_node10w[51]), {w219w, {w_sum_node10w[60], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {(~ w_sum_node10w[12]), {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w228w, {w228w, {w219w, {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[49], {w_sum_node10w[48], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14:13]}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w228w, {w228w, {w228w, {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[27], {w_sum_node10w[26], {2{w228w}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w228w, {w_sum_node10w[50], {(~ w_sum_node10w[38]), {w219w, {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40:39]}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w228w, {w228w, {w228w, {w_sum_node10w[59], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29:28]}}}}}}}}}}}};
	assign
		dataa_node = {dataa[10:0]},
		datab_node = {datab[9:0]},
		final_result_node = {w370w[20:0]},
		result = {final_result_node[20:0]},
		w219w = 1'b1,
		w228w = 1'b0,
		w370w = {wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[10:0]} & {11{w_le_datab_node8w[9]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[8]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[7]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[6]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[5]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[4]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[3]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[2]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[1]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[9:0]},
		w_sum_node10w = {wire_sum_adder1aa_4result[11:0], w_decoder_node9w[88], wire_sum_adder1aa_3result[11:0], w_decoder_node9w[66], wire_sum_adder1aa_2result[11:0], w_decoder_node9w[44], wire_sum_adder1aa_1result[11:0], w_decoder_node9w[22], wire_sum_adder1aa_0result[11:0], w_decoder_node9w[0]};
endmodule //mult_2e01
//VALID FILE
