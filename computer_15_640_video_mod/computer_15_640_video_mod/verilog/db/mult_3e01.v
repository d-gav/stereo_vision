//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=10 LPM_WIDTHB=12 LPM_WIDTHP=22 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=13 cin dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
module  mult_3e01
	...
	wire	[12:0]	wire_sum_adder1aa_3dataa;
	wire	[12:0]	wire_sum_adder1aa_3datab;
	wire	[12:0]	wire_sum_adder1aa_3result;
	wire	[13:0]	wire_sum_adder1aa_4result_int;
	wire	wire_sum_adder1aa_4cin;
	wire	[12:0]	wire_sum_adder1aa_4dataa;
	wire	[12:0]	wire_sum_adder1aa_4datab;
	wire	[12:0]	wire_sum_adder1aa_4result;
	...
	wire  w235w;
	wire  [22:0]  w385w;
	wire  [119:0]  w_decoder_node9w;
	wire  [9:0]  w_le_datab_node8w;
	wire  [69:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_3dataa = {w_decoder_node9w[95], w_decoder_node9w[95:84]},
		wire_sum_adder1aa_3datab = {{2{w_decoder_node9w[83]}}, w_decoder_node9w[83:73]};
	assign
	...
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4result_int[13:1];
	assign
		wire_sum_adder1aa_4cin = 1'b1,
		wire_sum_adder1aa_4dataa = {(~ w_decoder_node9w[119]), (~ w_decoder_node9w[119:108])},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[107]}}, w_decoder_node9w[107:97]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w235w, {w235w, {w235w, {w235w, {(~ w_sum_node10w[27]), {w226w, {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {2{w235w}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w235w, {w_sum_node10w[26], w226w}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w235w, {w235w, w_sum_node10w[25]}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft3a_in = {w226w, {(~ w_sum_node10w[69]), {w_sum_node10w[68], {(~ w_sum_node10w[55]), {w226w, {w_sum_node10w[65], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {(~ w_sum_node10w[13]), {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w235w, {w235w, {w226w, {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[53], {w_sum_node10w[52], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w235w, {w235w, {w235w, {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[29], {w_sum_node10w[28], {2{w235w}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w235w, {w_sum_node10w[54], {(~ w_sum_node10w[41]), {w226w, {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43:42]}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w235w, {w235w, {w235w, {w_sum_node10w[64], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31:30]}}}}}}}}}}}}};
	assign
		dataa_node = {datab[11:0]},
		datab_node = {dataa[9:0]},
		final_result_node = {w385w[21:0]},
		result = {final_result_node[21:0]},
		w226w = 1'b1,
		w235w = 1'b0,
		w385w = {wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[11:0]} & {12{w_le_datab_node8w[9]}}), ({dataa_node[11:0]} & {12{w_le_datab_node8w[8]}}), ({dataa_node[11:0]} & {12{w_le_datab_node8w[7]}}), ({dataa_node[11:0]} & {12{w_le_datab_node8w[6]}}), ({dataa_node[11:0]} & {12{w_le_datab_node8w[5]}}), ({dataa_node[11:0]} & {12{w_le_datab_node8w[4]}}), ({dataa_node[11:0]} & {12{w_le_datab_node8w[3]}}), ({dataa_node[11:0]} & {12{w_le_datab_node8w[2]}}), ({dataa_node[11:0]} & {12{w_le_datab_node8w[1]}}), ({dataa_node[11:0]} & {12{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[9:0]},
		w_sum_node10w = {wire_sum_adder1aa_4result[12:0], w_decoder_node9w[96], wire_sum_adder1aa_3result[12:0], w_decoder_node9w[72], wire_sum_adder1aa_2result[12:0], w_decoder_node9w[48], wire_sum_adder1aa_1result[12:0], w_decoder_node9w[24], wire_sum_adder1aa_0result[12:0], w_decoder_node9w[0]};
endmodule //mult_3e01
//VALID FILE
