//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=13 LPM_WIDTHB=10 LPM_WIDTHP=23 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=14 dataa datab result
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=14 cin dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
module  mult_6e01
	...
	wire	[14:0]	wire_add7_result;
	wire	[13:0]	wire_sum_adder1aa_0dataa;
	wire	[13:0]	wire_sum_adder1aa_0datab;
	wire	[13:0]	wire_sum_adder1aa_0result;
	wire	[13:0]	wire_sum_adder1aa_1dataa;
	wire	[13:0]	wire_sum_adder1aa_1datab;
	wire	[13:0]	wire_sum_adder1aa_1result;
	wire	[13:0]	wire_sum_adder1aa_2dataa;
	wire	[13:0]	wire_sum_adder1aa_2datab;
	wire	[13:0]	wire_sum_adder1aa_2result;
	wire	[13:0]	wire_sum_adder1aa_3dataa;
	wire	[13:0]	wire_sum_adder1aa_3datab;
	wire	[13:0]	wire_sum_adder1aa_3result;
	wire	[14:0]	wire_sum_adder1aa_4result_int;
	wire	wire_sum_adder1aa_4cin;
	wire	[13:0]	wire_sum_adder1aa_4dataa;
	wire	[13:0]	wire_sum_adder1aa_4datab;
	wire	[13:0]	wire_sum_adder1aa_4result;
	wire  [14:0]   wire_sft10a_in;
	wire  [14:0]   wire_sft10a_out;
	wire  [14:0]   wire_sft11a_in;
	wire  [14:0]   wire_sft11a_out;
	...
	wire  [14:0]   wire_sft8a_in;
	wire  [14:0]   wire_sft8a_out;
	wire  [14:0]   wire_sft9a_in;
	wire  [14:0]   wire_sft9a_out;
	wire  [12:0]  dataa_node;
	wire  [9:0]  datab_node;
	wire  [22:0]  final_result_node;
	wire  w233w;
	wire  w242w;
	wire  [23:0]  w400w;
	wire  [129:0]  w_decoder_node9w;
	wire  [9:0]  w_le_datab_node8w;
	wire  [74:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_0dataa = {w_decoder_node9w[25], w_decoder_node9w[25:13]},
		wire_sum_adder1aa_0datab = {{2{w_decoder_node9w[12]}}, w_decoder_node9w[12:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {w_decoder_node9w[51], w_decoder_node9w[51:39]},
		wire_sum_adder1aa_1datab = {{2{w_decoder_node9w[38]}}, w_decoder_node9w[38:27]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {w_decoder_node9w[77], w_decoder_node9w[77:65]},
		wire_sum_adder1aa_2datab = {{2{w_decoder_node9w[64]}}, w_decoder_node9w[64:53]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {w_decoder_node9w[103], w_decoder_node9w[103:91]},
		wire_sum_adder1aa_3datab = {{2{w_decoder_node9w[90]}}, w_decoder_node9w[90:79]};
	assign
	...
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4result_int[14:1];
	assign
		wire_sum_adder1aa_4cin = 1'b1,
		wire_sum_adder1aa_4dataa = {(~ w_decoder_node9w[129]), (~ w_decoder_node9w[129:117])},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[116]}}, w_decoder_node9w[116:105]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w242w, {w242w, {w242w, {w242w, {(~ w_sum_node10w[29]), {w233w, {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {2{w242w}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w242w, {w_sum_node10w[28], w233w}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w242w, {w242w, w_sum_node10w[27]}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft3a_in = {w233w, {(~ w_sum_node10w[74]), {w_sum_node10w[73], {(~ w_sum_node10w[59]), {w233w, {w_sum_node10w[70], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {(~ w_sum_node10w[14]), {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w242w, {w242w, {w233w, {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[57], {w_sum_node10w[56], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16:15]}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w242w, {w242w, {w242w, {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[31], {w_sum_node10w[30], {2{w242w}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w242w, {w_sum_node10w[58], {(~ w_sum_node10w[44]), {w233w, {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46:45]}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w242w, {w242w, {w242w, {w_sum_node10w[69], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33:32]}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[12:0]},
		datab_node = {datab[9:0]},
		final_result_node = {w400w[22:0]},
		result = {final_result_node[22:0]},
		w233w = 1'b1,
		w242w = 1'b0,
		w400w = {wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[12:0]} & {13{w_le_datab_node8w[9]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[8]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[7]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[6]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[5]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[4]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[3]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[2]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[1]}}), ({dataa_node[12:0]} & {13{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[9:0]},
		w_sum_node10w = {wire_sum_adder1aa_4result[13:0], w_decoder_node9w[104], wire_sum_adder1aa_3result[13:0], w_decoder_node9w[78], wire_sum_adder1aa_2result[13:0], w_decoder_node9w[52], wire_sum_adder1aa_1result[13:0], w_decoder_node9w[26], wire_sum_adder1aa_0result[13:0], w_decoder_node9w[0]};
endmodule //mult_6e01
//VALID FILE
