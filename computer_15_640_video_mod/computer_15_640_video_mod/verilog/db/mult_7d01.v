//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=28 LPM_WIDTHB=9 LPM_WIDTHP=37 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_7d01
	...
	wire	[35:0]	wire_add2_result;
	wire	[30:0]	wire_add7_result;
	...
	wire  [30:0]   wire_sft10a_in;
	wire  [30:0]   wire_sft10a_out;
	wire  [30:0]   wire_sft11a_in;
	wire  [30:0]   wire_sft11a_out;
	...
	wire  [35:0]   wire_sft3a_in;
	wire  [35:0]   wire_sft3a_out;
	wire  [35:0]   wire_sft4a_in;
	wire  [35:0]   wire_sft4a_out;
	wire  [35:0]   wire_sft5a_in;
	wire  [35:0]   wire_sft5a_out;
	wire  [35:0]   wire_sft6a_in;
	wire  [35:0]   wire_sft6a_out;
	wire  [30:0]   wire_sft8a_in;
	wire  [30:0]   wire_sft8a_out;
	wire  [30:0]   wire_sft9a_in;
	wire  [30:0]   wire_sft9a_out;
	wire  [27:0]  dataa_node;
	wire  [8:0]  datab_node;
	wire  [36:0]  final_result_node;
	wire  w344w;
	wire  w376w;
	wire  [37:0]  w738w;
	wire  [251:0]  w_decoder_node9w;
	wire  [8:0]  w_le_datab_node8w;
	wire  [27:0]  w_lone_sum_node11w;
	wire  [119:0]  w_sum_node10w;
	...
	assign
		wire_sft10a_in = {w376w, {w376w, {w376w, {w376w, {w376w, {(~ w_sum_node10w[59]), {w344w, {(~ w_lone_sum_node11w[21]), {(~ w_lone_sum_node11w[20]), {(~ w_lone_sum_node11w[19]), {(~ w_lone_sum_node11w[18]), {(~ w_lone_sum_node11w[17]), {(~ w_lone_sum_node11w[16]), {(~ w_lone_sum_node11w[15]), {(~ w_lone_sum_node11w[14]), {(~ w_lone_sum_node11w[13]), {(~ w_lone_sum_node11w[12]), {(~ w_lone_sum_node11w[11]), {(~ w_lone_sum_node11w[10]), {(~ w_lone_sum_node11w[9]), {(~ w_lone_sum_node11w[8]), {(~ w_lone_sum_node11w[7]), {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), {(~ w_lone_sum_node11w[0]), {2{w376w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w376w, {w_sum_node10w[58], {w344w, {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], w344w}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w376w, {w376w, {w_sum_node10w[57], {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, w_sum_node10w[36]}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {w376w, {2{w376w}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft4a_in = {w376w, {w376w, {w_lone_sum_node11w[27], {(~ w_lone_sum_node11w[26]), {w_sum_node10w[117], {w_sum_node10w[116], {wire_sft11a_out[25], {wire_sft11a_out[24], {wire_sft11a_out[23], {wire_sft11a_out[22], {wire_sft11a_out[21], {wire_sft11a_out[20], {wire_sft11a_out[19], {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31:30]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w376w, {w376w, {wire_sft11a_out[29], {wire_sft11a_out[28], {wire_sft11a_out[27], {wire_sft11a_out[26], {wire_sft16a_out[23], {wire_sft16a_out[22], {wire_sft16a_out[21], {wire_sft16a_out[20], {wire_sft16a_out[19], {wire_sft16a_out[18], {wire_sft16a_out[17], {wire_sft16a_out[16], {wire_sft16a_out[15], {wire_sft16a_out[14], {wire_sft16a_out[13], {wire_sft16a_out[12], {wire_sft16a_out[11], {wire_sft16a_out[10], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[61], {w_sum_node10w[60], {2{w376w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w376w, {(~ w_sum_node10w[119]), {w_sum_node10w[118], {(~ w_sum_node10w[89]), {w344w, {(~ w_lone_sum_node11w[23]), {(~ w_lone_sum_node11w[22]), {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91:90]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		...
		w_lone_sum_node11w = {w_decoder_node9w[251:224]},
		w_sum_node10w = {wire_sum_adder1aa_3result[28:0], w_decoder_node9w[168], wire_sum_adder1aa_2result[28:0], w_decoder_node9w[112], wire_sum_adder1aa_1result[28:0], w_decoder_node9w[56], wire_sum_adder1aa_0result[28:0], w_decoder_node9w[0]};
endmodule //mult_7d01
//VALID FILE
