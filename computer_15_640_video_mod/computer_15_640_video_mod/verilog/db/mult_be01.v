//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=28 LPM_WIDTHB=12 LPM_WIDTHP=40 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//adder CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" WIDTH=24 dataa datab datac result
...
//adder CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" WIDTH=32 dataa datab datac result
//VERSION_BEGIN 18.1 cbx_mgl 2018:09:12:13:10:36:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END
...
module  mult_be01
	...
	wire	[23:0]	wire_add12_result;
	wire	[38:0]	wire_add2_result;
	wire	[31:0]	wire_add7_result;
	...
	wire	[29:0]	wire_sum_adder1aa_5result_int;
	wire	wire_sum_adder1aa_5cin;
	wire	[28:0]	wire_sum_adder1aa_5dataa;
	wire	[28:0]	wire_sum_adder1aa_5datab;
	wire	[28:0]	wire_sum_adder1aa_5result;
	wire  [31:0]   wire_sft10a_in;
	wire  [31:0]   wire_sft10a_out;
	wire  [31:0]   wire_sft11a_in;
	wire  [31:0]   wire_sft11a_out;
	wire  [23:0]   wire_sft13a_in;
	wire  [23:0]   wire_sft13a_out;
	wire  [23:0]   wire_sft14a_in;
	wire  [23:0]   wire_sft14a_out;
	wire  [23:0]   wire_sft15a_in;
	wire  [23:0]   wire_sft15a_out;
	wire  [23:0]   wire_sft16a_in;
	wire  [23:0]   wire_sft16a_out;
	wire  [38:0]   wire_sft3a_in;
	wire  [38:0]   wire_sft3a_out;
	wire  [38:0]   wire_sft4a_in;
	wire  [38:0]   wire_sft4a_out;
	wire  [38:0]   wire_sft5a_in;
	wire  [38:0]   wire_sft5a_out;
	wire  [38:0]   wire_sft6a_in;
	wire  [38:0]   wire_sft6a_out;
	wire  [31:0]   wire_sft8a_in;
	wire  [31:0]   wire_sft8a_out;
	wire  [31:0]   wire_sft9a_in;
	wire  [31:0]   wire_sft9a_out;
	wire  [27:0]  dataa_node;
	wire  [11:0]  datab_node;
	wire  [39:0]  final_result_node;
	wire  w413w;
	wire  w423w;
	wire  [40:0]  w803w;
	wire  [335:0]  w_decoder_node9w;
	wire  [11:0]  w_le_datab_node8w;
	...
	assign
		wire_sum_adder1aa_5result_int = {wire_sum_adder1aa_5dataa, wire_sum_adder1aa_5cin} + {wire_sum_adder1aa_5datab, wire_sum_adder1aa_5cin};
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5result_int[29:1];
	assign
		wire_sum_adder1aa_5cin = 1'b1,
	...
	assign
		wire_sft10a_in = {w423w, {w423w, {w423w, {w423w, {(~ w_sum_node10w[89]), {w413w, {w_sum_node10w[171], {w_sum_node10w[170], {w_sum_node10w[141], {w_sum_node10w[140], {w_sum_node10w[139], {w_sum_node10w[138], {w_sum_node10w[137], {w_sum_node10w[136], {w_sum_node10w[135], {w_sum_node10w[134], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[129], {w_sum_node10w[128], {w_sum_node10w[127], {w_sum_node10w[126], {w_sum_node10w[125], {w_sum_node10w[124], {w_sum_node10w[123], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[120], {2{w423w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft15a_in = {w423w, {w423w, {w423w, {w423w, {w413w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {w423w, {2{w423w}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft8a_in = {w423w, {w_sum_node10w[148], {(~ w_sum_node10w[119]), {w413w, {w_sum_node10w[173], {w_sum_node10w[172], {w_sum_node10w[143], {w_sum_node10w[142], {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91:90]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w423w, {w423w, {w423w, {w_sum_node10w[174], {w_sum_node10w[145], {w_sum_node10w[144], {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63:62]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[27:0]},
		datab_node = {datab[11:0]},
		final_result_node = {w803w[39:0]},
		result = {final_result_node[39:0]},
		w413w = 1'b1,
		w423w = 1'b0,
		w803w = {wire_sft6a_out[38:37], wire_sft6a_out[36:35], wire_sft6a_out[34:33], wire_sft6a_out[32:31], wire_sft6a_out[30:29], wire_sft6a_out[28:27], wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		...
		w_le_datab_node8w = {datab_node[11:0]},
