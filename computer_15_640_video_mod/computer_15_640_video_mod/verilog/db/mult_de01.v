//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=28 LPM_WIDTHB=13 LPM_WIDTHP=41 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//adder CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" WIDTH=40 dataa datab datac result
//VERSION_BEGIN 18.1 cbx_mgl 2018:09:12:13:10:36:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END


//adder CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" WIDTH=35 dataa datab datac result
//VERSION_BEGIN 18.1 cbx_mgl 2018:09:12:13:10:36:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END
...
module  mult_de01
	...
	wire	[25:0]	wire_add12_result;
	wire	[19:0]	wire_add17_result;
	wire	[39:0]	wire_add2_result;
	wire	[34:0]	wire_add7_result;
	...
	wire  [34:0]   wire_sft10a_in;
	wire  [34:0]   wire_sft10a_out;
	wire  [34:0]   wire_sft11a_in;
	wire  [34:0]   wire_sft11a_out;
	wire  [25:0]   wire_sft13a_in;
	wire  [25:0]   wire_sft13a_out;
	wire  [25:0]   wire_sft14a_in;
	wire  [25:0]   wire_sft14a_out;
	wire  [25:0]   wire_sft15a_in;
	wire  [25:0]   wire_sft15a_out;
	wire  [25:0]   wire_sft16a_in;
	wire  [25:0]   wire_sft16a_out;
	...
	wire  [39:0]   wire_sft3a_in;
	wire  [39:0]   wire_sft3a_out;
	wire  [39:0]   wire_sft4a_in;
	wire  [39:0]   wire_sft4a_out;
	wire  [39:0]   wire_sft5a_in;
	wire  [39:0]   wire_sft5a_out;
	wire  [39:0]   wire_sft6a_in;
	wire  [39:0]   wire_sft6a_out;
	wire  [34:0]   wire_sft8a_in;
	wire  [34:0]   wire_sft8a_out;
	wire  [34:0]   wire_sft9a_in;
	wire  [34:0]   wire_sft9a_out;
	wire  [27:0]  dataa_node;
	wire  [12:0]  datab_node;
	wire  [40:0]  final_result_node;
	wire  w476w;
	wire  w508w;
	wire  [41:0]  w989w;
	wire  [363:0]  w_decoder_node9w;
	wire  [12:0]  w_le_datab_node8w;
	wire  [27:0]  w_lone_sum_node11w;
	wire  [179:0]  w_sum_node10w;
	...
	assign
		wire_sft10a_in = {w508w, {w508w, {w508w, {w508w, {w508w, {(~ w_sum_node10w[119]), {w476w, {(~ w_lone_sum_node11w[21]), {(~ w_lone_sum_node11w[20]), {w_sum_node10w[171], {w_sum_node10w[170], {w_sum_node10w[141], {w_sum_node10w[140], {w_sum_node10w[139], {w_sum_node10w[138], {w_sum_node10w[137], {w_sum_node10w[136], {w_sum_node10w[135], {w_sum_node10w[134], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[129], {w_sum_node10w[128], {w_sum_node10w[127], {w_sum_node10w[126], {w_sum_node10w[125], {w_sum_node10w[124], {w_sum_node10w[123], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[120], {2{w508w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft19a_in = {w508w, {w508w, {(~ w_sum_node10w[29]), {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, w_sum_node10w[12]}}}}}}}}}}}}}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {w508w, {2{w508w}}}}}}}}}}}}}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft3a_in = {w476w, {wire_sft11a_out[34], {w476w, {w476w, {(~ w_lone_sum_node11w[25]), {w_sum_node10w[148], {w_sum_node10w[147], {w_sum_node10w[146], {w_sum_node10w[117], {w_sum_node10w[88], {wire_sft11a_out[25], {wire_sft11a_out[24], {wire_sft11a_out[23], {wire_sft11a_out[22], {wire_sft11a_out[21], {wire_sft11a_out[20], {wire_sft11a_out[19], {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w508w, {w508w, {w_lone_sum_node11w[27], {(~ w_lone_sum_node11w[26]), {w_sum_node10w[177], {w_sum_node10w[176], {wire_sft11a_out[29], {wire_sft11a_out[28], {wire_sft11a_out[27], {wire_sft11a_out[26], {wire_sft16a_out[21], {wire_sft16a_out[20], {wire_sft16a_out[19], {wire_sft16a_out[18], {wire_sft16a_out[17], {wire_sft16a_out[16], {wire_sft16a_out[15], {wire_sft16a_out[14], {wire_sft16a_out[13], {wire_sft16a_out[12], {wire_sft16a_out[11], {wire_sft16a_out[10], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31:30]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w508w, {w508w, {wire_sft11a_out[33], {wire_sft11a_out[32], {wire_sft11a_out[31], {wire_sft11a_out[30], {wire_sft16a_out[25], {wire_sft16a_out[24], {wire_sft16a_out[23], {wire_sft16a_out[22], {wire_sft21a_out[19], {wire_sft21a_out[18], {wire_sft21a_out[17], {wire_sft21a_out[16], {wire_sft21a_out[15], {wire_sft21a_out[14], {wire_sft21a_out[13], {wire_sft21a_out[12], {wire_sft21a_out[11], {wire_sft21a_out[10], {wire_sft21a_out[9], {wire_sft21a_out[8], {wire_sft21a_out[7], {wire_sft21a_out[6], {wire_sft21a_out[5], {wire_sft21a_out[4], {wire_sft21a_out[3], {wire_sft21a_out[2], {wire_sft21a_out[1], {wire_sft21a_out[0], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[61], {w_sum_node10w[60], {2{w508w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w508w, {(~ w_sum_node10w[179]), {w_sum_node10w[178], {(~ w_sum_node10w[149]), {w476w, {(~ w_lone_sum_node11w[23]), {(~ w_lone_sum_node11w[22]), {w_sum_node10w[173], {w_sum_node10w[172], {w_sum_node10w[143], {w_sum_node10w[142], {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91:90]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
