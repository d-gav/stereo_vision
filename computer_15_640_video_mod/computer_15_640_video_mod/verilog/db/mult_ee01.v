//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=16 LPM_WIDTHB=10 LPM_WIDTHP=26 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_ee01
	...
	wire	[17:0]	wire_sum_adder1aa_4result_int;
	...
	wire  [24:0]   wire_sft3a_in;
	wire  [24:0]   wire_sft3a_out;
	wire  [24:0]   wire_sft4a_in;
	wire  [24:0]   wire_sft4a_out;
	wire  [24:0]   wire_sft5a_in;
	wire  [24:0]   wire_sft5a_out;
	wire  [24:0]   wire_sft6a_in;
	wire  [24:0]   wire_sft6a_out;
	...
	wire  [9:0]  datab_node;
	wire  [25:0]  final_result_node;
	wire  w254w;
	wire  w263w;
	wire  [26:0]  w445w;
	wire  [159:0]  w_decoder_node9w;
	wire  [9:0]  w_le_datab_node8w;
	wire  [89:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_3dataa = {w_decoder_node9w[127], w_decoder_node9w[127:112]},
		wire_sum_adder1aa_3datab = {{2{w_decoder_node9w[111]}}, w_decoder_node9w[111:97]};
	assign
	...
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4result_int[17:1];
	assign
		wire_sum_adder1aa_4cin = 1'b1,
		wire_sum_adder1aa_4dataa = {(~ w_decoder_node9w[159]), (~ w_decoder_node9w[159:144])},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[143]}}, w_decoder_node9w[143:129]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w263w, {w263w, {w263w, {w263w, {(~ w_sum_node10w[35]), {w254w, {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {2{w263w}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w263w, {w_sum_node10w[34], w254w}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w263w, {w263w, w_sum_node10w[33]}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft3a_in = {w254w, {(~ w_sum_node10w[89]), {w_sum_node10w[88], {(~ w_sum_node10w[71]), {w254w, {w_sum_node10w[85], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {(~ w_sum_node10w[17]), {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w263w, {w263w, {w254w, {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[69], {w_sum_node10w[68], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19:18]}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w263w, {w263w, {w263w, {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[37], {w_sum_node10w[36], {2{w263w}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w263w, {w_sum_node10w[70], {(~ w_sum_node10w[53]), {w254w, {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55:54]}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w263w, {w263w, {w263w, {w_sum_node10w[84], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39:38]}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[15:0]},
		datab_node = {datab[9:0]},
		final_result_node = {w445w[25:0]},
		result = {final_result_node[25:0]},
		w254w = 1'b1,
		w263w = 1'b0,
		w445w = {wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		...
		w_sum_node10w = {wire_sum_adder1aa_4result[16:0], w_decoder_node9w[128], wire_sum_adder1aa_3result[16:0], w_decoder_node9w[96], wire_sum_adder1aa_2result[16:0], w_decoder_node9w[64], wire_sum_adder1aa_1result[16:0], w_decoder_node9w[32], wire_sum_adder1aa_0result[16:0], w_decoder_node9w[0]};
endmodule //mult_ee01
//VALID FILE
