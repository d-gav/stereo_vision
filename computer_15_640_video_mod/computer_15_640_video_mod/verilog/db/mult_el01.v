//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=27 LPM_WIDTHB=13 LPM_WIDTHP=40 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_el01
	...
	assign
		wire_sft13a_in = {w447w, {w_sum_node10w[86], {w_sum_node10w[85], {w_lone_sum_node11w[18], {w_lone_sum_node11w[17], {w_sum_node10w[163], {w_sum_node10w[162], {w_sum_node10w[161], {w_sum_node10w[160], {w_sum_node10w[159], {w_sum_node10w[158], {w_sum_node10w[157], {w_sum_node10w[156], {w_sum_node10w[155], {w_sum_node10w[154], {w_sum_node10w[153], {w_sum_node10w[152], {w_sum_node10w[151], {w_sum_node10w[150], {w_sum_node10w[149], {w_sum_node10w[148], {w_sum_node10w[147], {w_sum_node10w[146:145]}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft9a_in = {w447w, {w447w, {w447w, {w_sum_node10w[169], {w_sum_node10w[168], {w_sum_node10w[140], {w_sum_node10w[139], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61:60]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[26:0]},
		datab_node = {datab[12:0]},
		final_result_node = {w827w[39:0]},
		result = {final_result_node[39:0]},
		w447w = 1'b0,
		w827w = {wire_sft6a_out[38:37], wire_sft6a_out[36:35], wire_sft6a_out[34:33], wire_sft6a_out[32:31], wire_sft6a_out[30:29], wire_sft6a_out[28:27], wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[26:0]} & {27{w_le_datab_node8w[12]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[11]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[10]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[9]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[8]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[7]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[6]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[5]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[4]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[3]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[2]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[1]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[12:0]},
		w_lone_sum_node11w = {w_decoder_node9w[350:324]},
