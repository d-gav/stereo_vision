...
//adder CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" WIDTH=42 dataa datab datac result
//VERSION_BEGIN 18.1 cbx_mgl 2018:09:12:13:10:36:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END


//adder CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" WIDTH=37 dataa datab datac result
//VERSION_BEGIN 18.1 cbx_mgl 2018:09:12:13:10:36:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END
...
module  mult_he01
	...
	wire	[41:0]	wire_add2_result;
	wire	[36:0]	wire_add7_result;
	...
	wire  [36:0]   wire_sft10a_in;
	wire  [36:0]   wire_sft10a_out;
	wire  [36:0]   wire_sft11a_in;
	wire  [36:0]   wire_sft11a_out;
	...
	wire  [41:0]   wire_sft3a_in;
	wire  [41:0]   wire_sft3a_out;
	wire  [41:0]   wire_sft4a_in;
	wire  [41:0]   wire_sft4a_out;
	wire  [41:0]   wire_sft5a_in;
	wire  [41:0]   wire_sft5a_out;
	wire  [41:0]   wire_sft6a_in;
	wire  [41:0]   wire_sft6a_out;
	wire  [36:0]   wire_sft8a_in;
	wire  [36:0]   wire_sft8a_out;
	wire  [36:0]   wire_sft9a_in;
	wire  [36:0]   wire_sft9a_out;
	wire  [27:0]  dataa_node;
	wire  [14:0]  datab_node;
	wire  [42:0]  final_result_node;
	wire  [43:0]  w1071w;
	wire  w549w;
	wire  w565w;
	wire  [419:0]  w_decoder_node9w;
	wire  [14:0]  w_le_datab_node8w;
	wire  [27:0]  w_lone_sum_node11w;
	wire  [209:0]  w_sum_node10w;
	...
	assign
		wire_sft10a_in = {w565w, {w565w, {w565w, {w565w, {w565w, {(~ w_sum_node10w[149]), {w549w, {(~ w_lone_sum_node11w[21]), {(~ w_lone_sum_node11w[20]), {w_sum_node10w[201], {w_sum_node10w[200], {w_sum_node10w[171], {w_sum_node10w[170], {w_sum_node10w[141], {w_sum_node10w[140], {w_sum_node10w[139], {w_sum_node10w[138], {w_sum_node10w[137], {w_sum_node10w[136], {w_sum_node10w[135], {w_sum_node10w[134], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[129], {w_sum_node10w[128], {w_sum_node10w[127], {w_sum_node10w[126], {w_sum_node10w[125], {w_sum_node10w[124], {w_sum_node10w[123], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[120], {2{w565w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft18a_in = {w565w, {w_sum_node10w[88], {(~ w_sum_node10w[59]), {w549w, {(~ w_lone_sum_node11w[15]), {(~ w_lone_sum_node11w[14]), {(~ w_lone_sum_node11w[13]), {(~ w_lone_sum_node11w[12]), {(~ w_lone_sum_node11w[11]), {(~ w_lone_sum_node11w[10]), {(~ w_lone_sum_node11w[9]), {(~ w_lone_sum_node11w[8]), {(~ w_lone_sum_node11w[7]), {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), (~ w_lone_sum_node11w[0])}}}}}}}}}}}}}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft20a_in = {w565w, {w565w, {w565w, {w565w, {w549w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, {w565w, w549w}}}}}}}}}}}}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft8a_in = {w565w, {(~ w_sum_node10w[209]), {w_sum_node10w[208], {(~ w_sum_node10w[179]), {w549w, {(~ w_lone_sum_node11w[23]), {(~ w_lone_sum_node11w[22]), {w_sum_node10w[203], {w_sum_node10w[202], {w_sum_node10w[173], {w_sum_node10w[172], {w_sum_node10w[143], {w_sum_node10w[142], {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91:90]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
