...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=18 dataa datab result
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=18 cin dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END

//synthesis_resources = lut 186 
...
module  mult_ke01
	...
	wire	[18:0]	wire_add7_result;
	wire	[17:0]	wire_sum_adder1aa_0dataa;
	wire	[17:0]	wire_sum_adder1aa_0datab;
	wire	[17:0]	wire_sum_adder1aa_0result;
	wire	[17:0]	wire_sum_adder1aa_1dataa;
	wire	[17:0]	wire_sum_adder1aa_1datab;
	wire	[17:0]	wire_sum_adder1aa_1result;
	wire	[17:0]	wire_sum_adder1aa_2dataa;
	wire	[17:0]	wire_sum_adder1aa_2datab;
	wire	[17:0]	wire_sum_adder1aa_2result;
	wire	[17:0]	wire_sum_adder1aa_3dataa;
	wire	[17:0]	wire_sum_adder1aa_3datab;
	wire	[17:0]	wire_sum_adder1aa_3result;
	wire	[18:0]	wire_sum_adder1aa_4result_int;
	wire	wire_sum_adder1aa_4cin;
	wire	[17:0]	wire_sum_adder1aa_4dataa;
	wire	[17:0]	wire_sum_adder1aa_4datab;
	wire	[17:0]	wire_sum_adder1aa_4result;
	...
	wire  [18:0]   wire_sft8a_in;
	wire  [18:0]   wire_sft8a_out;
	wire  [18:0]   wire_sft9a_in;
	wire  [18:0]   wire_sft9a_out;
	wire  [16:0]  dataa_node;
	wire  [9:0]  datab_node;
	wire  [26:0]  final_result_node;
	wire  w261w;
	wire  w270w;
	wire  [27:0]  w460w;
	wire  [169:0]  w_decoder_node9w;
	wire  [9:0]  w_le_datab_node8w;
	wire  [94:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_0dataa = {w_decoder_node9w[33], w_decoder_node9w[33:17]},
		wire_sum_adder1aa_0datab = {{2{w_decoder_node9w[16]}}, w_decoder_node9w[16:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {w_decoder_node9w[67], w_decoder_node9w[67:51]},
		wire_sum_adder1aa_1datab = {{2{w_decoder_node9w[50]}}, w_decoder_node9w[50:35]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {w_decoder_node9w[101], w_decoder_node9w[101:85]},
		wire_sum_adder1aa_2datab = {{2{w_decoder_node9w[84]}}, w_decoder_node9w[84:69]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {w_decoder_node9w[135], w_decoder_node9w[135:119]},
		wire_sum_adder1aa_3datab = {{2{w_decoder_node9w[118]}}, w_decoder_node9w[118:103]};
	assign
	...
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4result_int[18:1];
	assign
		wire_sum_adder1aa_4cin = 1'b1,
		wire_sum_adder1aa_4dataa = {(~ w_decoder_node9w[169]), (~ w_decoder_node9w[169:153])},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[152]}}, w_decoder_node9w[152:137]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w270w, {w270w, {w270w, {w270w, {(~ w_sum_node10w[37]), {w261w, {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {2{w270w}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w270w, {w_sum_node10w[36], w261w}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w270w, {w270w, w_sum_node10w[35]}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft4a_in = {w270w, {w270w, {w261w, {w_sum_node10w[92], {w_sum_node10w[91], {w_sum_node10w[73], {w_sum_node10w[72], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20:19]}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w270w, {w270w, {w270w, {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[39], {w_sum_node10w[38], {2{w270w}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w270w, {w_sum_node10w[74], {(~ w_sum_node10w[56]), {w261w, {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58:57]}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w270w, {w270w, {w270w, {w_sum_node10w[89], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41:40]}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[16:0]},
		datab_node = {datab[9:0]},
		final_result_node = {w460w[26:0]},
		result = {final_result_node[26:0]},
		w261w = 1'b1,
		w270w = 1'b0,
		w460w = {wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[16:0]} & {17{w_le_datab_node8w[9]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[8]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[7]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[6]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[5]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[4]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[3]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[2]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[1]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[9:0]},
		w_sum_node10w = {wire_sum_adder1aa_4result[17:0], w_decoder_node9w[136], wire_sum_adder1aa_3result[17:0], w_decoder_node9w[102], wire_sum_adder1aa_2result[17:0], w_decoder_node9w[68], wire_sum_adder1aa_1result[17:0], w_decoder_node9w[34], wire_sum_adder1aa_0result[17:0], w_decoder_node9w[0]};
endmodule //mult_ke01
//VALID FILE
