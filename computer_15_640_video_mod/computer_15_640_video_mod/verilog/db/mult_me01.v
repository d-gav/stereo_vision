//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=10 LPM_WIDTHB=18 LPM_WIDTHP=28 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//adder CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" WIDTH=27 dataa datab datac result
//VERSION_BEGIN 18.1 cbx_mgl 2018:09:12:13:10:36:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=19 dataa datab result
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=19 cin dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
module  mult_me01
	...
	wire	[26:0]	wire_add2_result;
	wire	[19:0]	wire_add7_result;
	...
	wire	[18:0]	wire_sum_adder1aa_2dataa;
	wire	[18:0]	wire_sum_adder1aa_2datab;
	wire	[18:0]	wire_sum_adder1aa_2result;
	wire	[18:0]	wire_sum_adder1aa_3dataa;
	wire	[18:0]	wire_sum_adder1aa_3datab;
	wire	[18:0]	wire_sum_adder1aa_3result;
	wire	[19:0]	wire_sum_adder1aa_4result_int;
	wire	wire_sum_adder1aa_4cin;
	wire	[18:0]	wire_sum_adder1aa_4dataa;
	wire	[18:0]	wire_sum_adder1aa_4datab;
	wire	[18:0]	wire_sum_adder1aa_4result;
	wire  [19:0]   wire_sft10a_in;
	wire  [19:0]   wire_sft10a_out;
	wire  [19:0]   wire_sft11a_in;
	wire  [19:0]   wire_sft11a_out;
	...
	wire  [26:0]   wire_sft3a_in;
	wire  [26:0]   wire_sft3a_out;
	wire  [26:0]   wire_sft4a_in;
	wire  [26:0]   wire_sft4a_out;
	wire  [26:0]   wire_sft5a_in;
	wire  [26:0]   wire_sft5a_out;
	wire  [26:0]   wire_sft6a_in;
	wire  [26:0]   wire_sft6a_out;
	wire  [19:0]   wire_sft8a_in;
	wire  [19:0]   wire_sft8a_out;
	wire  [19:0]   wire_sft9a_in;
	wire  [19:0]   wire_sft9a_out;
	wire  [17:0]  dataa_node;
	wire  [9:0]  datab_node;
	wire  [27:0]  final_result_node;
	wire  w268w;
	wire  w277w;
	wire  [28:0]  w475w;
	wire  [179:0]  w_decoder_node9w;
	wire  [9:0]  w_le_datab_node8w;
	wire  [99:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_0dataa = {w_decoder_node9w[35], w_decoder_node9w[35:18]},
		wire_sum_adder1aa_0datab = {{2{w_decoder_node9w[17]}}, w_decoder_node9w[17:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {w_decoder_node9w[71], w_decoder_node9w[71:54]},
		wire_sum_adder1aa_1datab = {{2{w_decoder_node9w[53]}}, w_decoder_node9w[53:37]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {w_decoder_node9w[107], w_decoder_node9w[107:90]},
		wire_sum_adder1aa_2datab = {{2{w_decoder_node9w[89]}}, w_decoder_node9w[89:73]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {w_decoder_node9w[143], w_decoder_node9w[143:126]},
		wire_sum_adder1aa_3datab = {{2{w_decoder_node9w[125]}}, w_decoder_node9w[125:109]};
	assign
	...
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4result_int[19:1];
	assign
		wire_sum_adder1aa_4cin = 1'b1,
		wire_sum_adder1aa_4dataa = {(~ w_decoder_node9w[179]), (~ w_decoder_node9w[179:162])},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[161]}}, w_decoder_node9w[161:145]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w277w, {w277w, {w277w, {w277w, {(~ w_sum_node10w[39]), {w268w, {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {2{w277w}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w277w, {w_sum_node10w[38], w268w}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w277w, {w277w, w_sum_node10w[37]}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft4a_in = {w277w, {w277w, {w268w, {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[77], {w_sum_node10w[76], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21:20]}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w277w, {w277w, {w277w, {wire_sft11a_out[19], {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[41], {w_sum_node10w[40], {2{w277w}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w277w, {w_sum_node10w[78], {(~ w_sum_node10w[59]), {w268w, {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61:60]}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w277w, {w277w, {w277w, {w_sum_node10w[94], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43:42]}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[17:0]},
		datab_node = {dataa[9:0]},
		final_result_node = {w475w[27:0]},
		result = {final_result_node[27:0]},
		w268w = 1'b1,
		w277w = 1'b0,
		w475w = {wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[17:0]} & {18{w_le_datab_node8w[9]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[8]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[7]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[6]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[5]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[4]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[3]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[2]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[1]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[9:0]},
		w_sum_node10w = {wire_sum_adder1aa_4result[18:0], w_decoder_node9w[144], wire_sum_adder1aa_3result[18:0], w_decoder_node9w[108], wire_sum_adder1aa_2result[18:0], w_decoder_node9w[72], wire_sum_adder1aa_1result[18:0], w_decoder_node9w[36], wire_sum_adder1aa_0result[18:0], w_decoder_node9w[0]};
endmodule //mult_me01
//VALID FILE
