//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=28 LPM_WIDTHB=18 LPM_WIDTHP=46 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//adder CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" WIDTH=45 dataa datab datac result
//VERSION_BEGIN 18.1 cbx_mgl 2018:09:12:13:10:36:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=29 cin dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
module  mult_ne01
	...
	wire	[44:0]	wire_add2_result;
	wire	[2:0]	wire_add22_result;
	wire	[37:0]	wire_add7_result;
	...
	wire	[29:0]	wire_sum_adder1aa_8result_int;
	wire	wire_sum_adder1aa_8cin;
	wire	[28:0]	wire_sum_adder1aa_8dataa;
	wire	[28:0]	wire_sum_adder1aa_8datab;
	wire	[28:0]	wire_sum_adder1aa_8result;
	wire  [37:0]   wire_sft10a_in;
	wire  [37:0]   wire_sft10a_out;
	wire  [37:0]   wire_sft11a_in;
	wire  [37:0]   wire_sft11a_out;
	...
	wire  [2:0]   wire_sft23a_in;
	wire  [2:0]   wire_sft23a_out;
	wire  [2:0]   wire_sft24a_in;
	wire  [2:0]   wire_sft24a_out;
	wire  [2:0]   wire_sft25a_in;
	wire  [2:0]   wire_sft25a_out;
	wire  [2:0]   wire_sft26a_in;
	wire  [2:0]   wire_sft26a_out;
	wire  [44:0]   wire_sft3a_in;
	wire  [44:0]   wire_sft3a_out;
	wire  [44:0]   wire_sft4a_in;
	wire  [44:0]   wire_sft4a_out;
	wire  [44:0]   wire_sft5a_in;
	wire  [44:0]   wire_sft5a_out;
	wire  [44:0]   wire_sft6a_in;
	wire  [44:0]   wire_sft6a_out;
	wire  [37:0]   wire_sft8a_in;
	wire  [37:0]   wire_sft8a_out;
	wire  [37:0]   wire_sft9a_in;
	wire  [37:0]   wire_sft9a_out;
	wire  [27:0]  dataa_node;
	wire  [17:0]  datab_node;
	wire  [45:0]  final_result_node;
	wire  [46:0]  w1167w;
	wire  w602w;
	wire  w619w;
	wire  [503:0]  w_decoder_node9w;
	wire  [17:0]  w_le_datab_node8w;
	wire  [269:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_8result_int = {wire_sum_adder1aa_8dataa, wire_sum_adder1aa_8cin} + {wire_sum_adder1aa_8datab, wire_sum_adder1aa_8cin};
	assign
		wire_sum_adder1aa_8result = wire_sum_adder1aa_8result_int[29:1];
	assign
		wire_sum_adder1aa_8cin = 1'b1,
		wire_sum_adder1aa_8dataa = {(~ w_decoder_node9w[503]), (~ w_decoder_node9w[503:476])},
		wire_sum_adder1aa_8datab = {{2{w_decoder_node9w[475]}}, w_decoder_node9w[475:449]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w619w, {w619w, {w619w, {w619w, {(~ w_sum_node10w[179]), {w602w, {w_sum_node10w[261], {w_sum_node10w[260], {w_sum_node10w[231], {w_sum_node10w[230], {w_sum_node10w[201], {w_sum_node10w[200], {wire_sft26a_out[2], {wire_sft26a_out[1], {wire_sft26a_out[0], {w_sum_node10w[140], {w_sum_node10w[139], {w_sum_node10w[138], {w_sum_node10w[137], {w_sum_node10w[136], {w_sum_node10w[135], {w_sum_node10w[134], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[129], {w_sum_node10w[128], {w_sum_node10w[127], {w_sum_node10w[126], {w_sum_node10w[125], {w_sum_node10w[124], {w_sum_node10w[123], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[120], {2{w619w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft20a_in = {w619w, {w619w, {w619w, {w619w, {w_sum_node10w[143], {w602w, {w_sum_node10w[253], {w_sum_node10w[252], {w_sum_node10w[251], {w_sum_node10w[250], {w_sum_node10w[249], {w_sum_node10w[248], {w_sum_node10w[247], {w_sum_node10w[246], {w_sum_node10w[245], {w_sum_node10w[244], {w_sum_node10w[243], {w_sum_node10w[242], {w_sum_node10w[241], {w_sum_node10w[240], {2{w619w}}}}}}}}}}}}}}}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft23a_in = {w619w, {w_sum_node10w[142], w602w}};
	soft   sft24a_0
	( 
	...
	assign
		wire_sft24a_in = {w619w, {w619w, w_sum_node10w[141]}};
	soft   sft25a_0
	( 
	...
	assign
		wire_sft8a_in = {w619w, {w_sum_node10w[238], {(~ w_sum_node10w[209]), {w602w, {w_sum_node10w[263], {w_sum_node10w[262], {w_sum_node10w[233], {w_sum_node10w[232], {w_sum_node10w[203], {w_sum_node10w[202], {w_sum_node10w[173], {w_sum_node10w[172], {w_sum_node10w[171], {w_sum_node10w[170], {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91:90]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
