//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=10 LPM_WIDTHB=10 LPM_WIDTHP=20 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
//adder CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" WIDTH=12 dataa datab datac result
//VERSION_BEGIN 18.1 cbx_mgl 2018:09:12:13:10:36:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END
...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=11 cin dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
module  mult_vd01
	...
	wire	[11:0]	wire_sum_adder1aa_4result_int;
	...
	wire  [11:0]   wire_sft10a_in;
	wire  [11:0]   wire_sft10a_out;
	wire  [11:0]   wire_sft11a_in;
	wire  [11:0]   wire_sft11a_out;
	...
	wire  [11:0]   wire_sft8a_in;
	wire  [11:0]   wire_sft8a_out;
	wire  [11:0]   wire_sft9a_in;
	wire  [11:0]   wire_sft9a_out;
	wire  [9:0]  dataa_node;
	wire  [9:0]  datab_node;
	...
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4result_int[11:1];
	assign
		wire_sum_adder1aa_4cin = 1'b1,
		wire_sum_adder1aa_4dataa = {(~ w_decoder_node9w[99]), (~ w_decoder_node9w[99:90])},
		wire_sum_adder1aa_4datab = {{2{w_decoder_node9w[89]}}, w_decoder_node9w[89:81]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w221w, {w221w, {w221w, {w221w, {(~ w_sum_node10w[23]), {w212w, {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {2{w221w}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w221w, {w_sum_node10w[22], w212w}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w221w, {w221w, w_sum_node10w[21]}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft3a_in = {w212w, {(~ w_sum_node10w[59]), {w_sum_node10w[58], {(~ w_sum_node10w[47]), {w212w, {w_sum_node10w[55], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {(~ w_sum_node10w[11]), {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w221w, {w221w, {w212w, {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[45], {w_sum_node10w[44], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13:12]}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w221w, {w221w, {w221w, {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[25], {w_sum_node10w[24], {2{w221w}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w221w, {w_sum_node10w[46], {(~ w_sum_node10w[35]), {w212w, {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37:36]}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w221w, {w221w, {w221w, {w_sum_node10w[54], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27:26]}}}}}}}}}}};
	assign
		dataa_node = {dataa[9:0]},
		datab_node = {datab[9:0]},
		final_result_node = {w355w[19:0]},
		result = {final_result_node[19:0]},
		w212w = 1'b1,
		w221w = 1'b0,
		w355w = {wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
